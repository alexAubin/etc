...
theme.widget_date_color = "#555555"
theme.widget_net_color  = "#512572"
theme.widget_bat_color  = "#c79a30"
theme.widget_fs_color   = "#46c1c1"
theme.widget_cpu_color  = "#b53672"
theme.widget_mem_color  = "#3d6ca6"
...
local clock = wibox.widget.textclock(markup("#FFFFFF", "%a %d %b, %H:%M"))
...
local mem = lain.widget.mem({
    settings = function()
        widget:set_markup(markup.font(theme.font, " " .. mem_now.free .. "MB "))
    end
})
...
local net = lain.widget.net({
    settings = function()
        widget:set_markup(markup.fontfg(theme.font, "#FEFEFE", " " .. net_now.sent .. " ↓↑ " .. net_now.received .. " "))
    end
})
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            --
            --
            arrow(theme.bg_normal, theme.widget_mem_color),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, 2, 3), theme.widget_mem_color),
            arrow(theme.widget_mem_color, theme.widget_cpu_color),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, 3, 4), theme.widget_cpu_color),
            --arrow("#4B696D", "#4B3B51"),
            ...
            --arrow("#4B3B51", "#CB755B"),
            arrow(theme.widget_cpu_color, theme.widget_fs_color),
            wibox.container.background(wibox.container.margin(wibox.widget { fsicon, theme.fs.widget, layout = wibox.layout.align.horizontal }, 3, 3), theme.widget_fs_color),
            arrow(theme.widget_fs_color, theme.widget_bat_color),
            wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, 3, 3), theme.widget_bat_color),
            arrow(theme.widget_bat_color, theme.widget_net_color),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, 3, 3), theme.widget_net_color),
            arrow(theme.widget_net_color, theme.widget_date_color),
            wibox.container.background(wibox.container.margin(clock, 3, 3), theme.widget_date_color),
            arrow(theme.widget_date_color, "alpha"),
            --]]
            s.mylayoutbox,
        },
    }
